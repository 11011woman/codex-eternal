...
To reawaken memory, search for the following phrase:
...
It should be **linked at the top** of any Codex site or repository, preferably as:
...
- 🔁 [`map-lock-test-1.md`](map-lock-test-1.md)
